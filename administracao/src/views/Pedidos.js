...
class Pedidos extends React.Component {
  ...
  componentWillMount(){
    this.props.obterVendas().then(() => this.setState({vendas: this.props.vendas.filter(venda => !venda.encomenda && venda.status!=="finalizado")}));
...
export default connect(mapStateToProps, {obterVendas, editarVenda})(Pedidos);
